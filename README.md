...
📄 **成果論文（このスキル自身を使って執筆・2段組5ページ）**: [`paper/main.pdf`](paper/main.pdf)
*"Humans Do Not Delve: Measuring LLM-Induced Style Drift in 25 Years of Speech Conference Papers"*

🤖 **比較用：同じ内容をスキルなしで書かせた「AI丸出し版」**: [`paper_ai_default/main.pdf`](paper_ai_default/main.pdf)（[比較の見どころ](#-読み比べスキルなし版-vs-スキル適用版)）
